...
describe('GrowthProgram', () => {
  ...
  describe('#getUpcomingWeek', () => {
    ...
    it('returns finished in the 11th week', () => {
      let plantDate = moment().subtract(11, 'weeks');

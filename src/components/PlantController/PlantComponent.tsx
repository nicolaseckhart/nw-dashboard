...
export const PlantComponent: React.FC<Props> = ({ plantState }: Props) => {
  return (
	...
	C712.49,343.55,713.98,350.15,714.05,350.43z"
      ...
      <rect x="759.08" y="69.33" className="st15" width="105.92" height="20.43" />
      <text transform="matrix(1 0 0 1 759.083 77.9217)" className="st19 plant-labels">
        Current Period:
      </text>
      <rect x="759.08" y="84.57" className="st15" width="105.92" height="20.43" />
      <text transform="matrix(1 0 0 1 759.083 93.1626)" className="st19 plant-labels">
        Week 4 (Grow)
      </text>
    </svg>
  );
